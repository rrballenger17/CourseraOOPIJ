...
// Passed the grader script but is visiting too many nodes
// for A-start and Dijkstra 
...
public class MapGraph {
	...
	// graph points and lists of edges 
	private Map<GeographicPoint, List<Edge>> graph = null;
	...
	{
		//vertices are the keys - return the count
	...
	public int getNumEdges()
	{
		...
		// for each vertex, count its edges 
		// and return the sum of the edges
	...
	{
		// don't add null and redundant vertices
		if( location == null ){
			return false;
		}
		...
		// add the vertex to the graph map
	...
	public void addEdge(GeographicPoint from, GeographicPoint to, String roadName,
		...
		// create edge class and set values
		Edge e = new Edge();
		...
		// get edge set and look for existing edge
	...
	// get the path back to the start node
	private List<GeographicPoint> getChain(Map<GeographicPoint, GeographicPoint> parents, GeographicPoint start, GeographicPoint end){
		...
		// iterate through parents to get the path to the start node
		while(true){
			 					     ...
			 					     GeographicPoint goal, Consumer<GeographicPoint> nodeSearched)
	{
		...
		while(true){
			...
			for(Edge e: edges ){
				...
				// return path to start if its the goal node
